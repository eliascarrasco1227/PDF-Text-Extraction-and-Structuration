...
\appendix
\chapter{Anexo I. Esquemas en xml}
...
<!ELEMENT page (line | heading | title | interlinear_gloss | parallel_phrase)*>
<!ATTLIST page
...
<!ELEMENT interlinear_gloss (parallel_phrase?, morpheme_analysis?, syntactic_analysis?)>

<!ELEMENT parallel_phrase (original, translation)>
<!ELEMENT original (#PCDATA)>
<!ELEMENT translation (#PCDATA)>

<!ELEMENT morpheme_analysis (unit+)>
<!ELEMENT syntactic_analysis (unit+)>

<!ELEMENT unit (form, gloss)>
<!ELEMENT form (#PCDATA)>
...
\begin{lstlisting}[
    language={},
    label=code:modelo_glosa_inicial,
    caption={Ejemplo del esquema XML inicial utilizado para representar glosas interlineales}
]
<glosa_interlineal>
  <corpus_paralelo>
    <frase_original>k'am chi-Ø w-il-a'</frase_original>
    <frase_español>No lo veo</frase_español>
  </corpus_paralelo>
