...
El contrato estructural definitivo que rige la validación sintáctica del sistema se encuentra formalizado en el archivo \texttt{gramatica.dtd}, cuyo código se detalla en el Código~\ref{code:dtd}.
...
El módulo \texttt{experiment\_runner.py} actúa como coordinador del sistema, invocando secuencialmente los distintos componentes del \textit{pipeline} para cada experimento.
