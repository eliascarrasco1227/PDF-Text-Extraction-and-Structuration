...
\begin{itemize}
    ...
    \item Inferencia Inteligente: El uso de modelos de lenguaje de gran tamaño (Gemini 2.5 flash, 3.5 flash…) mediante técnicas de Few-Shot Learning para la extracción semántica de gramáticas complejas.
...
\begin{itemize}
    ...
    \item La sensibilidad a la temperatura es función de la dificultad de la página. Siete de las nueve páginas son prácticamente insensibles al parámetro (rango \textgreater 2 puntos). La temperatura solo produce variaciones de magnitud operativa en páginas que ya presentan dificultades para el sistema.
