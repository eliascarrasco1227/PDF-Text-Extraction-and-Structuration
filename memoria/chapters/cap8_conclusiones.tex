...
\begin{itemize}
    ...
    \item Inferencia Inteligente: El uso de modelos de lenguaje de gran tamaño (Gemini 1.5, 2.5…) mediante técnicas de Few-Shot Learning para la extracción semántica de gramáticas complejas.
        ...
        \item Garantía de calidad estructural: La implementación de una capa de validación basada en un Documento de Definición de Tipo (DTD) y un corrector heurístico que reduce las limitaciones sintácticas de la IA. Esta capa garantiza la coherencia formal del XML, aunque no sustituye la evaluación de fidelidad textual frente al documento original.
...
\begin{itemize}
        \item Aunque cada celda experimental se calculó como la media de tres ejecuciones, no se conservaron los valores individuales de cada intento. Por este motivo, no es posible calcular desviaciones típicas entre repeticiones ni realizar pruebas de significancia estadística. Las diferencias inferiores a 2 puntos porcentuales deben considerarse indicativas.
...
\begin{itemize}
    ...
    \item Tampoco es posible saber si las diferencias entre modelos se deben a la arquitectura, al entrenamiento con estas lenguas concretas, o a otros factores.
        ...
        \item La comparación solo es válida a temperatura \(T=1.0\), seleccionada por ser una configuración general recomendada por Gemini para tareas de propósito amplio. Por tanto, la dominancia observada de \texttt{gemini-3.5-flash} debe entenderse dentro de esta configuración experimental concreta.
\end{itemize}
