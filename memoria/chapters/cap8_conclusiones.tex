...
Una vez validado el pipeline en Kaqchikel, K’iche’ y Mam, el siguiente paso natural es extender el proceso a las restantes lenguas de la Academia de Lenguas Mayas de Guatemala.

\begin{itemize}
    \item Inclusión de lenguas con menos recursos: Aplicar la metodología al Q’eqchi’, Q’anjob’al y Poqomchi’, entre otros, para verificar si la capacidad de Transfer Learning del sistema se mantiene constante en toda la familia maya.
\end{itemize}
