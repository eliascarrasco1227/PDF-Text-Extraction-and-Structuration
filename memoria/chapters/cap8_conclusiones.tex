...
\begin{itemize}
    \item La temperatura 0,5 es la configuración globalmente recomendable para el sistema evaluado sobre este corpus. Es la única que maximiza simultáneamente la media de las puntuaciones CER (94,02) y minimiza su dispersión entre páginas (\(\sigma=5,06\)), ofreciendo el mejor rendimiento promedio con la mayor consistencia.
    ...
    \item La relación entre temperatura y CER no es monotónica. El ordenamiento de temperaturas por media global no sigue ningún patrón predecible de creatividad creciente. El óptimo global se sitúa en un punto intermedio (\(T=0,5\)), y los extremos del rango son los peores en términos de media.
\end{itemize}
...
\begin{itemize}
    ...
    Estado: Alcanzado. Se ha realizado una experimentación sistemática que ha permitido identificar el intervalo de 0.1 a 0.25 como el ``punto dulce'' de rendimiento, aportando una conclusión técnica de alto valor para futuros trabajos en el área.
