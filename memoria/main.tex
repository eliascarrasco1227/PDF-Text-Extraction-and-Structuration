...
\lstset{
    ...
    inputencoding=utf8,
    extendedchars=true,
    literate={á}{{\'a}}1 {ã}{{\~a}}1 {é}{{\'e}}1 {ó}{{\'o}}1 {ñ}{{\~n}}1 {ö}{{\"o}}1 {ø}{{$\emptyset$}}1
                {Ø}{{$\emptyset$}}1
}
...
%\input{chapters/cap3_viabilidad}
\input{chapters/cap3_estado_cuestion}
\input{chapters/cap2_objetivos}
\input{chapters/cap4_metodologia}
%\input{chapters/cap5_analisis}
\input{chapters/cap5_diseño}
%\input{chapters/cap6_implementacion}
\input{chapters/cap7_resultados}
\input{chapters/cap8_conclusiones}
\input{back_matter}
\end{document}