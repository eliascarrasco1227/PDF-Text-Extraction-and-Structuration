...
\ex
  	...
  	able \textbf{DET} \textbf{mujer} \textbf{CR} \textbf{COM-} \textbf{B3s-} \textbf{cansar} \textbf{COM-} \textbf{B3s-} \textbf{MOV-} \textbf{A3s-} \textbf{comprar-} \textbf{SC} \textbf{tomate}
  	ablf [ri ixöq]_{CR} [ri xkos]_{CR}
...
\ex
  	...
  	ablf [re ak'wal]_{CR} [re xtzaq]_{CR}
  \xe[\textit{Este niño que se cayó, lloró.}]
%
\ex
  	abla La k'ajöl, la xloq'o ri wexaj, xb'e.
  	ablz La k'ajöl la xloq'o ri wexaj
  	able \textbf{DET} \textbf{muchacho} \textbf{CR} \textbf{comprar} \textbf{CR} \textbf{pantalón}
  	ablf [la k'ajöl]_{CR} [la xloq'o ri wexaj]_{CR}
