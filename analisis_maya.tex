...
\glft \textbf{Sintaxis:} Xb'entz'eta' na kan ri ak'wal. [\textsc{SVT}] \\ `\textit{Todavía fui a ver al niño.}' //
\endgl
\xe
%
\medskip%
...
\glft \textbf{Sintaxis:} kan jeb'ël ok xerutz'ët ri ch'uta'q xtani' [\textsc{SVT}] \\ `\textit{...vio muy hermosas a las niñas...}' //
\endgl
\xe
%
\medskip%
...
\glft \textbf{Sintaxis:} Xkilöq' jun uqaj [\textsc{SVT}] \\ `\textit{Los dos hombres compraron un corte.}' //
\endgl
\xe
%
\medskip%
...
\glft \textbf{Sintaxis:} Xusipaj ri xkoya' [\textsc{SVT}] \\ `\textit{La señorita regaló el tomate.}' //
\endgl
\xe
%
\medskip%
...
\glb  //
\glc  //
\glft \textbf{Sintaxis:} nb'eqato' [\textsc{SVT}] \\ `\textit{...nuestro papá va a trabajar, vamos a ayudarlo,...}' //
\endgl
\xe
%
\medskip
