...
OUTPUT_DIR = 'output/experiment_results/gemini-2.5-flash/' #/GN-kaqchikel-205
...
GEMINI_MODEL = 'gemini-2.5-flash' #'gemini-3.1-flash-lite' #'gemini-2.5-flash-lite' #'gemini-2.5-flash'   # Modelo de Gemini a usar
