...
PDF_PATH = 'data/reducidos/Gramatica-Normativa-Kaqchikel_pag_205.pdf'
...
GEMINI_MODEL = 'gemma-3-27b-it' #'gemini-2.5-flash' #'gemini-2.5-flash-lite' #'gemini-2.5-flash' #'gemini-3-flash-preview' #  # #'gemma-3-27b-it' #'gemini-2.5-flash-lite' #  # Modelo de Gemini a usar
